...
def rand_str(length=32, type="lower_hex"):
    """
    Generate random string or number of specified length; can be used for keys and security scenarios
    :param length: Length of string or number
    :param type: 'str' for random string, 'num' for random number
    :return: Random string or number
    """
    if type == "str":
